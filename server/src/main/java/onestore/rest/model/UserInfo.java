...
public class UserInfo {
    ...
    public static UserInfo fromCoreModel(onestore.core.model.UserInfo userInfo) {
        return new UserInfo()
    ...
    public static onestore.core.model.UserInfo toCoreModel(UserInfo userInfo) {
        return new onestore.core.model.UserInfo()
            .username(userInfo.getUsername())
            .firstname(userInfo.getFirstname())
            .lastname(userInfo.getLastname())
            .password(userInfo.getPassword())
